...
Discussion of this work occurs on the [Autonomic Networking Integrated Model and Approach
Working Group mailing list](mailto:anima@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/anima/),
[subscribe](https://www.ietf.org/mailman/listinfo/anima)).
...
[Working Group documents](https://datatracker.ietf.org/wg/anima/documents/).
